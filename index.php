        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 text-center md:text-left">
                    <p class="text-purple-600 dark:text-purple-400 font-medium mb-4 animate-fade-in">Hello, I'm</p>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-lg mb-10 max-w-lg mx-auto md:mx-0 animate-fade-in" style="animation-delay: 0.3s;">
                        I craft beautiful, responsive, and user-friendly web applications that solve real-world problems and deliver exceptional user experiences.
                    </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="animate-on-scroll">
                    <h3 class="text-2xl font-bold mb-6">A Passionate Developer & Problem Solver</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        With over 5 years of experience in web development, I specialize in creating modern, scalable, and user-centric applications. My journey started with a curiosity about how websites work, and it has evolved into a deep passion for crafting digital experiences.
                    </p>
                    <p class="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        I believe in writing clean, maintainable code and staying up-to-date with the latest technologies. When I'm not coding, you'll find me exploring new frameworks, contributing to open-source projects, or sharing knowledge through my blog.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full gradient-bg"></div>
                            <span class="text-gray-600 dark:text-gray-400">5+ Years Experience</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full gradient-bg"></div>
                            <span class="text-gray-600 dark:text-gray-400">50+ Projects Completed</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full gradient-bg"></div>
                            <span class="text-gray-600 dark:text-gray-400">30+ Happy Clients</span>
                        </div>
                    </div>
                </div>
    ...
    <section id="resume" class="py-20 bg-gray-50 dark:bg-gray-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="space-y-8">
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            ...
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2022 - Present</span>
                                <h4 class="text-xl font-bold mt-2">Senior Full-Stack Developer</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">Tech Innovations Inc.</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Leading development of enterprise web applications, mentoring junior developers, and implementing best practices.</p>
                            </div>
                        </div>
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            <div class="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 rounded-full gradient-bg"></div>
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2020 - 2022</span>
                                <h4 class="text-xl font-bold mt-2">Full-Stack Developer</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">Digital Solutions Co.</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Developed and maintained multiple client websites and web applications using PHP, JavaScript, and modern frameworks.</p>
                            </div>
                        </div>
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            <div class="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 rounded-full gradient-bg"></div>
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2018 - 2020</span>
                                <h4 class="text-xl font-bold mt-2">Junior Web Developer</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">StartUp Hub</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Started my professional journey building responsive websites and learning modern development practices.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="animate-on-scroll">
                    ...
                    <div class="space-y-8">
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            <div class="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 rounded-full gradient-bg"></div>
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2014 - 2018</span>
                                <h4 class="text-xl font-bold mt-2">B.S. Computer Science</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">State University</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Graduated with honors. Focused on software engineering, database systems, and web technologies.</p>
                            </div>
                        </div>
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            <div class="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 rounded-full gradient-bg"></div>
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2020</span>
                                <h4 class="text-xl font-bold mt-2">AWS Certified Developer</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">Amazon Web Services</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Professional certification for developing and maintaining applications on AWS.</p>
                            </div>
                        </div>
                        <div class="relative pl-8 border-l-2 border-purple-500/30">
                            <div class="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 rounded-full gradient-bg"></div>
                            <div class="glass-card rounded-xl p-6">
                                <span class="text-purple-600 dark:text-purple-400 text-sm font-medium">2021</span>
                                <h4 class="text-xl font-bold mt-2">Full-Stack Web Development</h4>
                                <p class="text-gray-500 dark:text-gray-400 mb-3">Udemy Certification</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Comprehensive course covering modern web development technologies and best practices.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center mt-12 animate-on-scroll">
                <a href="#" class="inline-flex items-center gap-3 gradient-bg text-white px-8 py-4 rounded-full font-semibold hover:opacity-90 transform hover:scale-105 transition-all duration-300 shadow-lg shadow-purple-500/25">
                ...
                <div class="animate-on-scroll">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@johndoe.com" class="font-medium hover:text-purple-600 dark:hover:text-purple-400 transition-colors">hello@johndoe.com</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+1234567890" class="font-medium hover:text-purple-600 dark:hover:text-purple-400 transition-colors">+1 (234) 567-890</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex gap-4">
                            <a href="#" class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-all duration-300">
    ...
    <footer class="py-12 bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-all duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                    </a>
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center hover:bg-purple-600 hover:text-white transition-all duration-300">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
